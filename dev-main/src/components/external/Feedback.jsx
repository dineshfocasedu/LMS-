...
const Card = ({ student, batch, Userimage, feedback }) => {
    return (<div className="w-[80vw] mx-auto sm:w-[45vw] lg:w-[40vw] min-h-[280px] sm:min-h-[320px] lg:min-h-[300px] rounded-xl flex items-center justify-around border border-black py-4 sm:py-6 px-3 sm:px-4 sm:mx-3 lg:mx-4">
      <div className="w-[40%] flex-shrink-0 max-[770px]:hidden">
        <img src={Userimage} alt="" className="w-full h-[200px] sm:h-[250px] lg:h-[300px] border border-black rounded-lg object-cover" loading="lazy" decoding="async"/>
      </div>
      <div className="w-full md:w-[55%] flex flex-col justify-between py-2 gap-4 sm:gap-6">
        <img src="/quote.png" alt="" className="w-[50px] sm:w-[60px] lg:w-[75px] object-fill hidden sm:block flex-shrink-0" loading="lazy" decoding="async"/>
    ...
    return (<div className="w-full px-4 sm:px-6 lg:px-8">
      ...
      <div className="w-full mt-3 sm:mt-4 py-8 sm:py-10 relative">
        ...
        <div className="flex justify-center mt-6 sm:mt-8 space-x-4">
          <button onClick={prevCards} className="rounded-full p-3 md:p-4 transition-all duration-300 hover:scale-110 focus:outline-none bg-white cursor-pointer border border-gray-200 shadow-md hover:shadow-lg hover:border-blue-300 hover:text-blue-600 text-gray-500" type="button">
            <HiChevronLeft className="w-5 h-5 md:w-6 md:h-6"/>
          </button>
          <button onClick={nextCards} className="rounded-full p-3 md:p-4 transition-all duration-300 hover:scale-110 focus:outline-none bg-blue-600 hover:bg-blue-700 cursor-pointer shadow-md hover:shadow-lg text-white" type="button">
